...
import { buildSafeDefaults } from '@/src/handler/middleware/httpStackCustomization';
import { assertInvariants, getId } from '@/src/handler/middleware/transformUtils';
...
describe('buildSafeDefaults', () => {
  it('produces phases satisfying invariants', () => {
    ...
    expect(() => { assertInvariants(phases); }).not.toThrow();
  });
