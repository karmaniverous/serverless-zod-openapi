...
export interface GlobalParamsNode<
  GlobalParamsSchema extends ZodObject<ZodRawShape>,
> extends EnvKeysNode<GlobalParamsSchema> {  params: z.infer<GlobalParamsSchema>;
}
...
export interface StageParamsNode<
  StageParamsSchema extends ZodObject<ZodRawShape>,
> extends EnvKeysNode<StageParamsSchema> {  params: Record<string, z.infer<StageParamsSchema>>;
}
...
export interface DefineAppConfigOutput<
  GlobalParamsSchema extends ZodObject<ZodRawShape>,
  StageParamsSchema extends ZodObject<ZodRawShape>,> extends GlobalEnvConfig<GlobalParamsSchema, StageParamsSchema> {
